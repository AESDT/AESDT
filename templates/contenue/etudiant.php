	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="accueil.html" class="logo"><strong><h2 style= "color:Tomato;">Les Etudiants</h2></strong></a>
									<ul class="icons">
                ...
                $query = "SELECT * FROM personnes WHERE type_personne=2 ;";
...
?>
  <div class="column">
		...
		<p><strong>Nom : </strong><?php echo $row['nom']; ?><br>       
                ...
                <strong>Universite :</strong> <?php echo $row['etablissement']; ?><br>
